...
const Status: React.FC<StatusProps> = ({ title, value, valueClassName }) => {
	return (
		<div className="bg-background/10 backdrop-blur-md pl-3 pr-2 py-2 rounded-full border border-foreground/10 border-gray-300 shadow-xl flex items-center justify-center gap-3">
